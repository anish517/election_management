      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 10),
            Text('Download CSV Template', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ],
        ),
        content: Column(
          ...
          children: [
            const Text(
              'Choose your preferred CSV template format:',
              style: TextStyle(fontSize: 13, color: Colors.grey),
            ),
            const SizedBox(height: 14),
            ListTile(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12), side: BorderSide(color: Colors.green.shade700.withValues(alpha: 0.4))),
              tileColor: Colors.green.withValues(alpha: 0.08),
              leading: const Icon(Icons.auto_awesome_rounded, color: Colors.green),
              title: const Text('Without Voter ID (Recommended)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13.5)),
              subtitle: const Text('Voter IDs (V001, V002...) will be auto-generated by the system', style: TextStyle(fontSize: 11.5)),
              onTap: () {
                Navigator.pop(ctx);
                _downloadCsvFile(
                  "prefix,first_name,middle_name,last_name,email,phone,council_number,citizenship_number\n"
                  "Mr.,Ramesh,Prasad,Shrestha,ramesh.shrestha@example.com,9841000001,NNC-101,27-01-76-00001\n"
                  "Ms.,Sita,,Sharma,sita.sharma@example.com,9841000002,,27-01-76-00002\n"
                  "Dr.,Bikash,,Karki,bikash.karki@example.com,9841000003,NMC-504,27-01-76-00003\n",
                  'voters_template_auto_id.csv',
                );
              },
            ),
            ...
            ListTile(
              ...
              title: const Text('With Custom Voter ID', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13.5)),
              subtitle: const Text('Specify your organization\'s custom Voter ID codes in the CSV', style: TextStyle(fontSize: 11.5)),
              onTap: () {
                Navigator.pop(ctx);
                _downloadCsvFile(
                  "voter_id,prefix,first_name,middle_name,last_name,email,phone,council_number,citizenship_number\n"
                  "V-001,Mr.,Ramesh,Prasad,Shrestha,ramesh.shrestha@example.com,9841000001,NNC-101,27-01-76-00001\n"
                  "V-002,Ms.,Sita,,Sharma,sita.sharma@example.com,9841000002,,27-01-76-00002\n",
                  'voters_template_custom_id.csv',
                );
              },
            ),
          ],
